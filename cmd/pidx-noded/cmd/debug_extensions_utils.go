...
import (
	...
	pidxnodecli "github.com/pointidentity/pidx-node/x/client/cli"
...
func getDocumentSignature(doc types.SsiMsg, docProof *types.DocumentProof, privateKey string) (string, error) {
	...
	case types.Ed25519Signature2020:
		...
		signature, err = pidxnodecli.GetEd25519Signature2020(privateKey, docBytes)
		if err != nil {
			return "", err
		}
	case types.EcdsaSecp256k1Signature2019:
		...
		signature, err = pidxnodecli.GetEcdsaSecp256k1Signature2019(privateKey, docBytes)
		if err != nil {
			return "", err
		}
	case types.EcdsaSecp256k1RecoverySignature2020:
		...
		signature, err = pidxnodecli.GetEcdsaSecp256k1RecoverySignature2020(privateKey, docBytes)
		if err != nil {
			return "", err
		}
	case types.BbsBlsSignature2020:
		...
		signature, err = pidxnodecli.GetBbsBlsSignature2020(privateKey, docBytes)
		if err != nil {
			return "", err
		}
	case types.BJJSignature2021:
		...
		signature, err = pidxnodecli.GetBJJSignature2021(privateKey, docBytes)
		if err != nil {
			return "", err
		}
	default:
