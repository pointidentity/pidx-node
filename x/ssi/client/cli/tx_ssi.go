	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			if didAlias == "" {
				...
				kr, err := keyring.New("pidx-node-app", keyringBackend, didAliasConfig.PidxNodeConfigDir, nil, clientCtx.Codec)
				if err != nil {
					return err
				}
