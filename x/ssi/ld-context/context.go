...
const X25519KeyAgreementKeyEIP5630Context string = "https://raw.githubusercontent.com/pointidentity/pointidentity-contexts/main/X25519KeyAgreementKeyEIP5630.jsonld"
const CredentialStatusContext string = "https://raw.githubusercontent.com/pointidentity/pointidentity-contexts/main/CredentialStatus.jsonld"
const CredentialSchemaContext string = "https://raw.githubusercontent.com/pointidentity/pointidentity-contexts/main/CredentialSchema.jsonld"
const BabyJubJubKey2021Context string = "https://raw.githubusercontent.com/pointidentity/pointidentity-contexts/main/BabyJubJubKey2021.jsonld"
const BJJSignature2021Context string = "https://raw.githubusercontent.com/pointidentity/pointidentity-contexts/main/BJJSignature2021.jsonld"
const LinkedDomainsContext string = "https://raw.githubusercontent.com/pointidentity/pointidentity-contexts/main/LinkedDomains.jsonld"

// As pidx-node is not supposed to perform any GET request, the complete Context body of their
...
var ContextUrlMap map[string]contextObject = map[string]contextObject{
	...
	CredentialStatusContext: {
		"@protected":      true,
		"@version":        1.1,
		"pointidentity-vocab": "urn:uuid:13fe9318-bb82-4d95-8bf5-8e7fdf8b2026#",
		"xsd":             "http://www.w3.org/2001/XMLSchema#",
		"id":              "@id",
		"revoked": map[string]interface{}{
			"@id":   "pointidentity-vocab:revoked",
			"@type": "xsd:boolean",
		},
		"suspended": map[string]interface{}{
			"@id":   "pointidentity-vocab:suspended",
			"@type": "xsd:boolean",
		},
		"remarks": map[string]interface{}{
			"@id":   "pointidentity-vocab:remarks",
			"@type": "xsd:string",
		},
		"issuer": map[string]interface{}{
			"@id":   "pointidentity-vocab:issuer",
			"@type": "xsd:string",
		},
		"issuanceDate": map[string]interface{}{
			"@id":   "pointidentity-vocab:issuanceDate",
			"@type": "xsd:dateTime",
		},
		"credentialMerkleRootHash": map[string]interface{}{
			"@id":   "pointidentity-vocab:credentialMerkleRootHash",
			"@type": "xsd:string",
		},
	},
	CredentialSchemaContext: {
		...
		"type": map[string]interface{}{
			"@id": "pointidentity-vocab:type",
		},
		"modelVersion": map[string]interface{}{
			"@id":   "pointidentity-vocab:modelVersion",
			"@type": "xsd:string",
		},
		"name": map[string]interface{}{
			"@id":   "pointidentity-vocab:name",
			"@type": "xsd:string",
		},
		"author": map[string]interface{}{
			"@id":   "pointidentity-vocab:author",
			"@type": "xsd:string",
		},
		"authored": map[string]interface{}{
			"@id":   "pointidentity-vocab:authored",
			"@type": "xsd:dateTime",
		},
		"schema": map[string]interface{}{
			"@id":   "pointidentity-vocab:schema",
			"@type": "xsd:string",
		},
		"additionalProperties": map[string]interface{}{
			"@id":   "pointidentity-vocab:additionalProperties",
			"@type": "xsd:boolean",
		},
		"description": map[string]interface{}{
			"@id":   "pointidentity-vocab:description",
			"@type": "xsd:string",
		},
		"properties": map[string]interface{}{
			"@id":   "pointidentity-vocab:properties",
			"@type": "xsd:string",
		},
		"required": map[string]interface{}{
			"@id":        "pointidentity-vocab:required",
			"@container": "@set",
		},
	},
	BabyJubJubKey2021Context: {
		...
		"BabyJubJubKey2021": map[string]interface{}{
			"@id": "pointidentity-vocab:BabyJubJubKey2021",
			"@context": map[string]interface{}{
				"@protected": true,
				"id":         "@id",
				"type":       "@type",
