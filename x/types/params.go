...
var (
	DefaultRegisterDIDFee              = sdk.NewInt64Coin("upidx", 4000)
	DefaultUpdateDIDFee                = sdk.NewInt64Coin("upidx", 1000)
	DefaultDeactivateDIDFee            = sdk.NewInt64Coin("upidx", 1000)
	DefaultRegisterCredentialSchemaFee = sdk.NewInt64Coin("upidx", 2000)
	DefaultUpdateCredentialSchemaFee   = sdk.NewInt64Coin("upidx", 2000)
	DefaultRegisterCredentialStatusFee = sdk.NewInt64Coin("upidx", 2000)
	DefaultUpdateCredentialStatusFee   = sdk.NewInt64Coin("upidx", 2000)
)
...
func validateFeeParams(i interface{}) error {
	...
	if v.Denom != "upidx" {
		return fmt.Errorf("fee param denom must be 'upidx', got %v", v.Denom)
	}
