...
// NewPointidentityApp returns a reference to an initialized WasmApp.
func NewPointidentityApp(
	logger log.Logger,
	db dbm.DB,
	...
	keys := sdk.NewKVStoreKeys(authtypes.StoreKey, banktypes.StoreKey, stakingtypes.StoreKey, crisistypes.StoreKey,
		...
		wasmtypes.StoreKey, ssitypes.StoreKey)
	...
	app.ConsensusKeeper = consensuskeeper.NewKeeper(appCodec, keys[consensustypes.StoreKey], authtypes.NewModuleAddress(govtypes.ModuleName).String())
	...
	app.SsiKeeper = *ssikeeper.NewKeeper(
		appCodec,
		keys[ssitypes.StoreKey],
		keys[ssitypes.MemStoreKey],
		app.getSubspace(ssitypes.ModuleName),
	)
	...
	*/
	...
	app.mm = module.NewManager(
		...
		ssi.NewAppModule(appCodec, app.SsiKeeper, app.AccountKeeper, app.BankKeeper),
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(ssitypes.ModuleName).WithKeyTable(ssitypes.ParamKeyTable())
