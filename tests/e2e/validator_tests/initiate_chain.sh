...
# add peers
sed -i -E "s|persistent_peers = \"\"|persistent_peers = \"$(pidx-noded tendermint show-node-id --home=${VAL_1_HOME_DIR})@127.0.0.1:36656\"|g" ${VAL_2_HOME_DIR}/config/config.toml
