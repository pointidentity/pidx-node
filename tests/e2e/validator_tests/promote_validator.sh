...
VAL_1_HOME_DIR=$HOME/.pidx-node/$VALIDATOR_1_NAME
VAL_2_HOME_DIR=$HOME/.pidx-node/$VALIDATOR_2_NAME

VALIDATOR_1_RPC="tcp://127.0.0.1:36657"
VALIDATOR_2_RPC="tcp://127.0.0.1:46657"

VALIDATOR_1_WALLET_ADDRESS=$(pidx-noded keys show ${VALIDATOR_1_WALLET} -a --keyring-backend=test --home=${VAL_1_HOME_DIR})
VALIDATOR_2_WALLET_ADDRESS=$(pidx-noded keys show ${VALIDATOR_2_WALLET} -a --keyring-backend=test --home=${VAL_2_HOME_DIR})
